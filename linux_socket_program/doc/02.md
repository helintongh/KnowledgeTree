...
- [3.socket属性相关函数](#3socket属性相关函数)
  * [3.1查询网络信息相关函数的使用](#3.1查询网络信息相关函数的使用)
  * [3.2设置和获取socket属性函数的使用](#3.2设置和获取socket属性函数的使用)
- [4.网络超时检测机制](#4.网络超时检测机制)
  * [4.1利用setsockopt设置socket属性为SO_RCVTIMEO实现超时检测](#4.1利用setsockopt设置socket属性为SO_RCVTIMEO实现超时检测)
  * [4.2调用select函数实现超时检测](#4.2调用select函数实现超时检测)
  * [4.3使用信号机制实现超时检测](#4.3使用信号机制实现超时检测)
